...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  // 3) Create token and send it to client
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // we use + for the fields which are not selected by default
  // because we select password false in model schema
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  // we set validateBeforeSave to false because we don't want to validate the user for email and password
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
  // Useer.findByIdAndUpdate will not work as intended!
  // if we use findByIdAndUpdate below issues can occur
  // 1) validation will not work because this.password will not if we use update (behind the scenes mongoose does not keep the current object in memory)
  // 2) pre save middleware will not work
