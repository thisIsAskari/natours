...
var dislayMap = exports.dislayMap = function dislayMap(locations) {
  // mapboxgl.accessToken = 'YOUR_MAPBOX_ACCESS_TOKEN';
  // const map = new mapboxgl.Map({
  //   style: 'mapbox://styles/mapbox/streets-v12',
  // scrollZoom: false,
  //   container: 'map', // container ID
  //   center: [-118.113491, 34.111745], // starting position [lng, lat]. Note that lat must be set between -90 and 9
...
if (logoutBtn) {
  logoutBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    return _regenerator().w(function (_context) {
